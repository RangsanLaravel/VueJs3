    ...
    <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
        <div
            ...
            <ul class="flex items-center flex-shrink-0 space-x-6">
                <!-- Notifications menu -->
                <li class="relative">
                    <button @click="onClickShowNotificationMenu" class="relative align-middle rounded-md focus:outline-none focus:shadow-outline-purple"
                    ...
                    <template :class="{ 'block': showNotificationMenu }">
                        ...
                        <li class="flex">
                            <a @click="onclickMessage" class="inline-flex items-center justify-between w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200" href="#">
                                <span>Messages</span>
                        ...
                        <li class="flex">
                            <a @click="onclickSale" class="inline-flex items-center justify-between w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200"
                            href="#">
                                <span>Sales</span>
                        ...
                        <li @click="onclickAlert" class="flex">
