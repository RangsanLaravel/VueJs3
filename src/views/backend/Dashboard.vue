<template>
    ...
    <!-- New Table -->
    <div class="w-full overflow-hidden rounded-lg shadow-xs sm:hidden md:hidden lg:block">
...
<script>
    ...
    export default {
        mounted() {
            const ctx_line = document.getElementById('line-chart')
            new Chart(ctx_line, chartdata.lineChartData)
            const ctx_bar = document.getElementById('bar-chart')
            new Chart(ctx_bar, chartdata.barChartData)
        }
    }
</script>
